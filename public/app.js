...
async function saveGalleryItem(e) {
  ...
  if (isEdit) {
    ...
    appState.gallery.unshift(payload);
  }
  ...
  await updateAdminSpaceIndicator();
}
...
async function deleteGalleryItem(id) {
  ...
  // Immediately filter appState.gallery, sync localStorage, and re-render DOM
  ...
  try {
    ...
    console.warn('Backend API notice in deleteGalleryItem:', err.message);
  }
